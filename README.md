...
# merupakan bagian dari inisialisasi dictionary dengan value sebagai kode
...
# inisialisasi list gejala user lalu looping key dan value pada dictionary daftar_gejala, lalu print key value, jika pilihan baris dijawab dengan y maka masukan key pada gejala_user
...
# inisialisasi list hasil_diagnosa lalu looping key dan value pada dictionary basis_pengetahuan, lalu jika value gejala_syarat ada di gejala_user maka masukan pada list hasil_diagnosa
...
# print hasil diagnosa dengan menggunakan loop iterasi pada list hasil_diagnosa
